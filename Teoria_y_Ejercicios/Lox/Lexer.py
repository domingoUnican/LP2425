...
'''
    ...
    tipo: Tipo del token
    __post_init__: Método que se ejecuta después de la inicialización de la clase que se encarga de actaulizar el valor del token en un tipo TokenType
'''
...
def tokenize(entrada):
    ...
    while pos < len(entrada):
        ...
        if next_state:
            ...
            ignore = [TokenType.TSpace, TokenType.TCommentLine, TokenType.TLine]
