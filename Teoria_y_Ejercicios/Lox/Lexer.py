...
tokens_to_ignore = [TokenType.TComment, TokenType.TCommentLine]
...
prueba4 = "or and "
prueba5 = "1.2.3.4 and 1...5"
pruebas = [prueba1, prueba2, prueba3, prueba4, prueba5]
...
test5 = [
    Token(lineno=1, value="1.2", tipo=TokenType.TNumber),
    Token(lineno=1, value=".", tipo=TokenType.TDot),
    Token(lineno=1, value="3.4", tipo=TokenType.TNumber),
    Token(lineno=1, value=" ", tipo=TokenType.TSpace),
    Token(lineno=1, value="and", tipo=TokenType.TAnd),
    Token(lineno=1, value=" ", tipo=TokenType.TSpace),
    Token(lineno=1, value="1.", tipo=TokenType.TNumber),
...
La clase token sirve para construir un objeto Token a partir del token leido por la funcion tokenize().
Cada vez que se emite un token, el método __post_init__() asigna el tipo de token haciendo uso del enumerado
TokenType. En caso de existir el tipo para el token, se le asigna; en otro caso, el tipo de token será el por
defecto (TokenType.TNothing).
"""
